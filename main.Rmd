...
author: "Hannah Long"
date: "`r Sys.Date()`"
title: "Exploring the Association between Tennis Match Statistics and Match Winners"
output:
...
boxplots <- ggarrange(FSP_plot, FSW_plot, SSW_plot, ACE_plot, WNR_plot, UFE_plot, BPC_plot, BPW_plot,
                      ncol = 2, nrow = 2, font.label=list(color="black",size=5))
...
data.frame(summary(boost)) %>%
  ...
  mutate(Variable = case_when(Variable == "FSP.1" ~ "First Serve Percentage (Player 1)",
                              ...
                              Variable == "NPW.2" ~ "Net Points Won (Player 2)",
                              Variable == "(Intercept)" ~ "Intercept")) %>% 
  kable(format = "markdown", digits=3, caption="Overall Classification Tree Relative Variable Influence")
```
...
```{r}
data.frame(summary(boost_women)) %>%
  mutate(`Relative Influence` = `rel.inf`) %>%
  dplyr::select(`Relative Influence`) %>% 
  tibble::rownames_to_column(var= "Variable") %>% 
  mutate(Variable = case_when(Variable == "FSP.1" ~ "First Serve Percentage (Player 1)",
                              ...
                              Variable == "NPW.2" ~ "Net Points Won (Player 2)",
                              Variable == "(Intercept)" ~ "Intercept")) %>% 
  kable(format = "markdown", digits=3, caption="Women Classification Tree Relative Variable Influence")
```
...
data.frame(summary(boost_men)) %>%
  ...
  mutate(Variable = case_when(Variable == "FSP.1" ~ "First Serve Percentage (Player 1)",
                              ...
                              Variable == "NPW.2" ~ "Net Points Won (Player 2)",
                              Variable == "(Intercept)" ~ "Intercept")) %>% 
  kable(format = "markdown", digits=3, caption="Men Classification Tree Relative Variable Influence")
```
...
data.frame(summary(boost_aus)) %>%
  ...
  mutate(Variable = case_when(Variable == "FSP.1" ~ "First Serve Percentage (Player 1)",
                              ...
                              Variable == "NPW.2" ~ "Net Points Won (Player 2)",
                              Variable == "(Intercept)" ~ "Intercept")) %>% 
  kable(format = "markdown", digits=3, caption="Australian Open Classification Tree Relative Variable Influence")
```
...
```{r}
data.frame(summary(boost_french)) %>%
  mutate(`Relative Influence` = `rel.inf`) %>%
  dplyr::select(`Relative Influence`) %>% 
  tibble::rownames_to_column(var= "Variable") %>% 
  mutate(Variable = case_when(Variable == "FSP.1" ~ "First Serve Percentage (Player 1)",
                              ...
                              Variable == "NPW.2" ~ "Net Points Won (Player 2)",
                              Variable == "(Intercept)" ~ "Intercept")) %>% 
  kable(format = "markdown", digits=3, caption="French Open Classification Tree Relative Variable Influence")
```
...
```{r}
data.frame(summary(boost_wimbledon)) %>%
  mutate(`Relative Influence` = `rel.inf`) %>%
  dplyr::select(`Relative Influence`) %>% 
  tibble::rownames_to_column(var= "Variable") %>% 
  mutate(Variable = case_when(Variable == "FSP.1" ~ "First Serve Percentage (Player 1)",
                              ...
                              Variable == "NPW.2" ~ "Net Points Won (Player 2)",
                              Variable == "(Intercept)" ~ "Intercept")) %>% 
  kable(format = "markdown", digits=3, caption="Wimbledon Classification Tree Relative Variable Influence")
```
